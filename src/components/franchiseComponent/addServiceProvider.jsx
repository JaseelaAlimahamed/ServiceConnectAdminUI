...
function AddServiceProvider(){
    ...
    const buttonConfig = [
        ...
        },
        {
            ...
            className : 'my-4  h-12 px-4 py-2 flex bg-white border-2 text-[#4D44B5] rounded-3xl text-md sm:text-md hover:bg-[#4D44B5] hover:text-white',
        },
        {
            type : 'submit',
            children : 'Submit',
        ...
        <>
            <div className=" h-full m-2 bg-lite_blue2 rounded-b-md shadow-md">
                ...
                <div className="justify-start sm:flex grid">
                    ...
                    <div className="w-fit h-52 mx-8 mt-8 grid sm:mx-8 cursor-pointer" onClick={handleImageClick}>
                    ...
                    <div className="mx-4 mt-8 w-80 sm:w-96 sm:px-auto md:px-auto">
                        <FormComponent
