...
function Franchisee({franchiseename,validity,contactname,daysleft,address,phone,email}) {
  return (
    ...
    <div className="mt-24">
      <div className="mx-10">
        ...
        <p className="text-lg font-bold text-dark_blue">{daysleft}days left <span className='ml-5'>  Valid up to {validity} </span></p>
