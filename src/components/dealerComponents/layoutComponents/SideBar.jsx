...
import { menuItems,Mainicon } from "./SideBarComponent";
    ...
    return (
      <div className="relative ">
        ...
        <div
          ...
          } fixed top-0 left-0 overflow-y-auto h-screen w-64 bg-violet transform transition-transform duration-300 ease-in-out md:translate-x-0 md:relative md:flex md:w-64 flex-col justify-between pl-5 py-5`}
        >
          ...
          <ul className="space-y-4">
            {menuItems.map((item) => (
              ...
              ><Link  to={`/dealer/${item.to}`}className="flex items-center w-full">
