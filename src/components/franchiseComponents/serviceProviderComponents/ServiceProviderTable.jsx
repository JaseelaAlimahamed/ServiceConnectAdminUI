...
const ServiceProviderTable = ({tableDataConfig,tableColConfig,tableConfig}) => {
  ...
  return (
    <div className="flex flex-col font-poppins text-secondary ">
      ...
      <button className="flex items-center justify-center bg-violet rounded-full hover:opacity-90 duration-300 px-14 h-12 gap-2">
            ...
            <div ><IoMdArrowDropdown className='w-8 h-8 px-0 mx-0 text-white'/> </div>
          </button>
        ...
        <div className="flex gap-4 flex-wrap">
          ...
          <button className="flex items-center justify-center bg-violet rounded-full hover:opacity-90 duration-300 px-14 h-12 gap-2">
            <img src="/add-icon.svg" alt="new Service Provider" />
        ...
        {currentUsers.map((data, index) => (
          ...
          >
            ...
            <div className="text-sm">
              <p className="text-sm">Registered Services: {data.registeredServices}</p>
              <p className="text-sm ">
                Active Jobs:{" "}
          ...
          <tbody>
            {currentUsers.map((data, index) => (
              <tr key={index} className={`border-t border-gray`}>
                ...
                {/* RegisteredServices Column */}
                <td className="text-sm text-dark_blue font-semibold text-sm">
                  <div className="mr-2">
                    <span className="whitespace-nowrap">{data.registeredServices}</span>{" "}
                  </div>
                </td>
