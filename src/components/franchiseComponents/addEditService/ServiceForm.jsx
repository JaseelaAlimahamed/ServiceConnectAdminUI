...
const ServiceForm = ({
  ...
  return (
    <form
      ...
      className="flex flex-col mt-7 space-y-4 w-full"
    >
...
if (field.type === "select") {
  return (
    <div key={field.name} className="flex items-center mt-2 w-full ">
      <div className="w-full">
        <select
          ...
          className="appearance-none bg-white border-2 font-bold shadow-xl border-black text-black placeholder:text-black w-full h-[50px] rounded-lg px-2 leading-tight  py-2 focus:outline-none"
        >
      ...
      {formik.touched[field.name] && formik.errors[field.name] ? (
        <div className="text-red-500 text-sm mt-1">
          ...
          return (
            <div key={field.name} className="w-full lg:w-full">
              <ServiceInputField
                icon={field.icon}
          ...
          return (
            <div key={field.name} className="flex items-center mt-2 w-full lg:w-full">
              <div className="relative w-[350px]">
                {/* File input */}
                <div className={`appearance-none bg-white text-[15px] border-2 font-bold shadow-xl border-black text-black placeholder:text-black w-full h-[50px] rounded-lg px-2 leading-tight py-2 focus:outline-none`}>
