  ...
  return (
    <div className="w-full h-20 font-poppins">
      <nav className="flex items-center justify-between px-4 md:px-8 h-full">
        ...
        <div className="hidden lg:inline-flex rounded-full  justify-center items-center bg-white pl-3  ">
                <div><CiSearch/></div>
                <input className=" outline-none text-black text-lg placeholder:text-sm p-2 rounded-full" type="search" placeholder="Search here..." name="" id="" />
            </div>
          {/* Notification Icon */}
