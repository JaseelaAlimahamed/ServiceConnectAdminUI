...
const Addnewservices = ({ label, placeholder }) => {
    ...
    <div className="App">
      <div className="container max-w-[95%] sm:max-w-[80%] lg:max-w-[60%] xl:max-w-[50%] mx-auto h-auto mt-10 rounded-2xl bg-[#C4C4C41F]">
        <div className="rounded-t-xl h-[60px] w-full bg-[#4D44B5]">
          <p
            className="text-white text-2xl pl-5 pt-3 font-bold"
        ...
        <h2 className="mt-10 ml-5 text-xl font-semibold text-[#202244]">
  ...
  <input
    type="checkbox"
    className="form-checkbox w-6 h-6 bg-black text-black"
  />
  <span className="ml-2 font-bold text-black">Accept</span>
      ...
      <Buttonreuse
  bgColor="bg-[#E20000]"
  width="w-[158px] md:w-[120px] lg:w-[158px]"
...
<Buttonreuse
  bgColor="bg-[#4D44B5]"
  width="w-[100px] md:w-[80px] lg:w-[100px]"
  height="h-[60px] md:h-[50px] lg:h-[60px]"
  borderRadius="rounded-full"
  type="submit"
  className="p-4"
