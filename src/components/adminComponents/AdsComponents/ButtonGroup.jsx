  ...
  return (
    <div className="flex space-x-4 mb-10">
      ...
      <div className="relative">
        ...
        {dropdownOpen && (
          <div className="absolute left-0 mt-2 w-full bg-primary border border-light_gray rounded shadow-md z-10">
            <button
      ...
      {/* Save Button */}
      <button type="submit" className="bg-violet text-primary px-8 py-2 rounded-full" onClick={handleSubmit}>
        Save
      </button>
    </div>
  );
