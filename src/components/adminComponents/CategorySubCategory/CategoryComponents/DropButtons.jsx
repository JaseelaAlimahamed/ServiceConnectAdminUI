    ...
    return (
        <div className="flex gap-4 relative">
            ...
            <div className="relative">
                <button
                    className="btn px-4 py-2 text-sm text-violet outline outline-violet rounded-full 
                    "
                ...
                {sortDropdownOpen && (
                    <div className="absolute left-0 mt-2 w-48 bg-blue_bg shadow-lg rounded-md z-10">
                        <ul>
                            <li className="px-4 py-2 hover:bg-blue_gray cursor-pointer">Sort by Name</li>
                            <li className="px-4 py-2 hover:bg-blue_gray cursor-pointer">Sort by Date</li>
                            <li className="px-4 py-2 hover:bg-blue_gray cursor-pointer">Sort by Price</li>
                        </ul>
                    </div>
                )}
            </div>
            ...
            <div className="relative">
                <button
                    className="btn px-4 py-2 text-sm text-primary bg-violet rounded-full 
                    "
                    onClick={toggleMainDropdown}
                >
                    <span className='flex items-center font-semibold gap-3 sm:gap-3'>
                        {selectedCategory ? selectedCategory.name : 'Select '} {/* Display selected category or prompt */}
