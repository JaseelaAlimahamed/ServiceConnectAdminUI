...
import PhotoUpload from '../../components/franchiseComponents/addDealerComponents/ProfilePhotoAddDealer';
import ButtonDealerComponent from '../../components/franchiseComponents/addDealerComponents/ButtonDealerComponent';
  ...
  return (   
      ...
      <div className="flex flex-col  max-w-full mt-4 mr-3 min-h-screen w-full bg-blue_bg">        
        ...
        <form className="flex flex-col bg-primary  w-full rounded-none mx-auto"  onSubmit={onFormSubmit}>
          ...
          <ButtonDealerComponent className="bg-red hover:bg-soft_red text-white font-bold py-2 px-7 mx-3 rounded-3xl " title = "Delete" type=""/>
          <ButtonDealerComponent className="bg-blue_bg hover:bg-text-white text-violet font-bold py-2 px-7 border-2 border-text-violet  mx-3 rounded-3xl border-violet" title = "Save as Draft" type=""/>
          <ButtonDealerComponent className="bg-violet hover:bg-blue-700 text-white font-bold py-2 px-7  mx-3 rounded-3xl "  title = "Submit" type="submit"/>
         </div>
        </form>      
      </div>
    </div>
