...
const AddServicePage = ({ label, placeholder }) => {
  ...
  return (
    <div className="App">
        ...
        <div className="ml-5">
          <div className="flex">
            <div className="w-full">
              <ServiceForm initialValues={initialValues} onSubmit={handleSubmit} fields={fields} />
            </div>
          </div>

          <div className="mt-2">
            <ServiceImageUpload title="Add image and video" IconComponent={LuImage} showTerms={false} />
          </div>
      ...
      <div className="flex mt-10 ml-auto text-sm space-x-5 lg:ml-[1000px] xl:ml-[1200px] 2xl:ml-[1250px]">
        <ServiceButton bgColor="bg-[#E20000]" width="w-[158px]" height="h-[60px]" borderRadius="rounded-full" type="submit">
          Delete
        </ServiceButton>
        <ServiceButton
        ...
        <ServiceButton bgColor="bg-[#4D44B5]" width="w-[100px]" height="h-[60px]" borderRadius="rounded-full" type="submit" className="p-4">
          Submit
        </ServiceButton>
      </div>
    </div>
